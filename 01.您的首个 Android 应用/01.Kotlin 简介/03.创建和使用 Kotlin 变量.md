...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/72302735e50d7d85.png" width="264">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/3284dfd6d8e70a60.png" width="608" alt="此图显示了变量如何能像盒子存储物品那样存储数据。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/df27215a9b673eb6.png" width="848" alt="新闻应用示例。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/ce8ced6770622864.png" width="1600" alt="此图示并排显示了 3 个盒子。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/a7e1f5184e4e3b15.png" width="758" alt="地图应用示例。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/a7e1f5184e4e3b15.png" width="758" alt="数据类型匹配练习。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/a1688b9b297c7501.png" width="1209" alt="YouTube视频详情屏幕示例。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/f515a6481cc91bf2.png" width="758" alt="短信应用示例。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/2e4abc418a62b510.png" width="564" alt="这里有一个标着 count 的盒子。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/e399b1ba43c613c9.png" width="690" alt="表达式求值。">
</div>

"求值"的意思是确定表达式的值。在本例中，表达式的求值结果为 2。编译器会对代码中的表达式求值，并在执行程序中的指令时使用这些值。

<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/24ccc51828dbb8c8.png" width="596" alt="表达式 count 的求值结果为 2。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/2e4abc418a62b510.png" width="564" alt="count 变量。">
</div>

若要通晓在 Kotlin 中声明变量的语法（或格式），您可能需要花费一些时间。下图显示了变量应处位置的各个细节，以及空格和符号的位置。

<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/dfcab30373610cbb.png" width="1164" alt="在 Kotlin 中声明变量的语法。">
</div>

在下面的 count 变量示例中，您可以看到以单词 val 开头的变量声明。该变量的名称为 count，数据类型为 Int，初始值为 2。

<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/50906b878985720e.png" width="662" alt="变量声明各部分。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/f978656666936b4f.png" width="940" alt="变量声明中突出显示名称部分。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/96e070df465b32c6.png" width="936" alt="变量声明中突出显示数据类型部分。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/14c69d3231012a14.png" width="932" alt="变量声明中突出显示初始值部分。">
</div>

在 count 变量示例中，2 就是该变量的初始值。

<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/31056b7a9891d9a5.png" width="570" alt="值 2 存储在 count 变量中。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/c9d83ec2fa51b2ff.png" width="1440" alt="使用字符串模板的字符串。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/8364ee0a12aca09.png" width="686" alt="使用类型推断在 Kotlin 中声明变量的语法。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/f86b6ec34074392.png" width="822" alt="表达式 unreadCount + readCount 的结果。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/c78c68b803cb53cb.png" width="532" alt="cartTotal = 20，箭头从 20 指向 cartTotal。">
</div>

以盒子为喻，想象 20 这个值是存储在标着 cartTotal（购物车总金额）的盒子里。

<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/74b153a08d38d640.png" width="714" alt="标着 cartTotal 的盒子，值为 20。">
</div>

下图显示了更新变量的一般语法：

<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/c1fc5d800976e702.png" width="768" alt="在 Kotlin 中更新变量的语法。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/d274bbe91769d766.png" width="698" alt="count = count + 1 表达式求值。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/9286c52fa350bb58.png" width="1490" alt="totalTripLength 变量声明。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/b474317797c50bf.png" width="1484" alt="两个串联的变量。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/932144819db18c30.png" width="584" alt="编码规范：冒号后的空格。">
</div>

- 加号 (+)、减号 (-)、乘号 (*)、除号 (/) 等运算符的前后应有空格。

<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/34f053ecba5f5a0b.png" width="568" alt="编码规范：运算符前后的空格。">
</div>
...
<div align="center">
<img src="../../image/1.1.3.创建和使用Kotlin变量/f4ee4d292ec7a78a.png" width="556" alt="var pet = 代码注释示例。">
</div>
